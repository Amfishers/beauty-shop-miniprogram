...
/* 0 */
/*!*************************************************************************************!*\
  !*** /Users/huangjiaru/fisher/mywork/side-work/beauty-industry/beauty_shop/main.js ***!
  \*************************************************************************************/
...
var _config = _interopRequireDefault(__webpack_require__(/*! @/common/config */ 41));
var _qs = _interopRequireDefault(__webpack_require__(/*! qs */ 42));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // @ts-ignore
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;var BRate = function BRate() {__webpack_require__.e(/*! require.ensure | components/rate/index */ "components/rate/index").then((function () {return resolve(__webpack_require__(/*! @/components/rate/index.vue */ 133));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var BIcon = function BIcon() {Promise.all(/*! require.ensure | components/icon/index */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/icon/index")]).then((function () {return resolve(__webpack_require__(/*! @/components/icon/index.vue */ 455));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var customHeader = function customHeader() {__webpack_require__.e(/*! require.ensure | components/customHeader/index */ "components/customHeader/index").then((function () {return resolve(__webpack_require__(/*! @/components/customHeader/index.vue */ 461));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var backToTop = function backToTop() {__webpack_require__.e(/*! require.ensure | components/backToTop/index */ "components/backToTop/index").then((function () {return resolve(__webpack_require__(/*! @/components/backToTop/index.vue */ 468));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var loadMore = function loadMore() {__webpack_require__.e(/*! require.ensure | components/loadmore/index */ "components/loadmore/index").then((function () {return resolve(__webpack_require__(/*! @/components/loadmore/index.vue */ 475));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
_vue.default.component('BRate', BRate);
_vue.default.component('BIcon', BIcon);
_vue.default.component("cu-custom", customHeader);
_vue.default.component("back-top-top", backToTop);
_vue.default.component("LoadMore", loadMore);


_vue.default.prototype.$cfg = _config.default;
...
_vue.default.prototype.$saveShareId = function (option) {
  // console.log(qs.parse(option));
  if (option.scene) {
    var scene = decodeURIComponent(option.scene);
    var wxArgs = _qs.default.parse(scene);
    if (wxArgs.shareId) {
      _store.default.commit('user/SET_SHAREID', wxArgs.shareId);
    }
    if (wxArgs.uid) {//新增二维码参数uid为分享者id
      _store.default.commit('user/SET_SHAREID', wxArgs.uid);
    }
  }
  if (option.shareId) {
    _store.default.commit('user/SET_SHAREID', option.shareId);
  }
};
...
/* 6 */
/*!*************************************************************************************!*\
  !*** /Users/huangjiaru/fisher/mywork/side-work/beauty-industry/beauty_shop/App.vue ***!
  \*************************************************************************************/
/*! no static exports found */
...
/* 7 */
/*!**************************************************************************************************************!*\
  !*** /Users/huangjiaru/fisher/mywork/side-work/beauty-industry/beauty_shop/App.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 8 */
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/huangjiaru/fisher/mywork/side-work/beauty-industry/beauty_shop/App.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  onLaunch: function onLaunch(option) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              uni.hideTabBar();

              if (option.query) {
                _this2.$saveShareId(option.query || {}); // 保存分享人ID 
              }_context.next = 4;return (

                _this2.GET_USER_LOCATION());case 4:_context.next = 6;return (

                _this2.GET_CURR_USER());case 6:
              ...
              uni.getSystemInfo({
                ...
                success: function success(e) {
                  ...
                  // 
                  var CustomBar = custom.bottom + custom.top - e.statusBarHeight; // +4 是为了多一点距离
                  _this.$store.commit('SET_CUSTOM_BAR', CustomBar);
                  _this.$store.commit('SET_STATUS_BAR', e.statusBarHeight);
                  _vue.default.prototype.CustomBar = CustomBar;
...
/* 13 */
/*!***********************************************************************************************************************!*\
  !*** /Users/huangjiaru/fisher/mywork/side-work/beauty-industry/beauty_shop/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 14 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/huangjiaru/fisher/mywork/side-work/beauty-industry/beauty_shop/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
